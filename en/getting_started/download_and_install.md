...
> **Tip** See [QGC Install/Config Problems](../Troubleshooting/troubleshooting_qgc.md) if you have any problem running *QGroundControl* after installation!
...
> **Note** The Windows installer creates 3 shortcuts: **QGroundControl**, **GPU Compatibility Mode**, **GPU Safe Mode**. 
  ...
  For more information see [QGC Install/Config Problems > Windows: UI Rendering/Video Driver Issues](../Troubleshooting/troubleshooting_qgc.md#opengl_troubleshooting).
...
> **Note** There are known [video steaming issues](../Troubleshooting/troubleshooting_qgc.md#dual_vga) on Ubuntu 18.04 systems with dual adaptors.
