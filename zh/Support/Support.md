...
This section is for troubleshooting the QGC host computer/configuration. Problems when *using QGroundControl* to interact with a vehicle are covered in: [Common Problems](../Support/CommonProblems.md).
