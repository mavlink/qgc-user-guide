...
* [애플리케이션 설정](SettingsView/SettingsView.md) 
  ...
  * [가상 조이스틱 (PX4)](SettingsView/VirtualJoystick.md)
...
* [배포](releases/README.md) 
  ...
  * [일일 빌드의 새로운 기능](releases/daily_build_new_features.md)
  * [개인정보 취급방침](releases/privacy_policy.md)
* [문제 해결](troubleshooting/README.md) 
  ...
  * [사용 문제](troubleshooting/qgc_usage.md) 
    ...
    * [플랜 업로드/다운로드 실패](troubleshooting/plan_upload_download.md)
